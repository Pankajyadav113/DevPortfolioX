...
import { GraduationCap, Award, Calendar, Sparkles, BookOpen, ExternalLink } from 'lucide-react';
              ...
              {CERTIFICATIONS.map((cert, idx) => (
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    {cert.verifyUrl ? (
                      <a
                        ...
                        className="px-2.5 py-0.5 rounded text-[10px] font-mono font-bold bg-emerald-500/10 text-emerald-700 dark:text-emerald-400 border border-emerald-500/30 hover:bg-emerald-500/20 transition-colors flex items-center gap-1.5"
                      >
                        <span>VERIFY</span>
                  ...
                  <div>
                    ...
                    <div className="flex items-center justify-between text-xs font-mono text-slate-600 dark:text-slate-400 mt-1">
                      <span>Issuer: {cert.issuer}</span>
                      {cert.date && <span className="text-[11px] opacity-80">{cert.date}</span>}
                    </div>
                  </div>
